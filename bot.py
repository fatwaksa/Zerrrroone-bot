...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_message = (
        "👋 مرحباً بك في **ZeroOne!**\n\n"
        "🔹 أرسل *اسم مستخدم سناب شات* لاستخراج القصص العامة بسهولة.\n\n"
        "💡 مثال: \n"
        "`snapchat`\n\n"
        "⚠️ ملاحظة: القصص الخاصة غير مدعومة.\n\n"
        "-----------------------------------\n"
        "🛠 تم تطوير البوت بواسطة: **عبدالعزيز الرويلي**\n"
        "🐦 تويتر: [@eb2uu](https://twitter.com/eb2uu)"
    )
